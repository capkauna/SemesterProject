...
public class AddACustomerView
{
  ...
  public AddACustomerView(Pane addACustomerPane)
  {
    ...
    addACustomerPane.setBackground(new Background(
    ...
    submitButton.setOnAction(e -> {
      ...
      String addressText = adressField.getText();
      ...
      if (nameText == null || nameText.trim().isEmpty()) {
        ...
        resultLabel.setText("Enter an address.");
      } else if (emailText == null || emailText.trim().isEmpty()) {
        resultLabel.setText("Enter an email.");
      } else {
        try {
          // get list from file
          ...
          resultLabel2.setText("Customer added successfully!");
        } catch (IOException ex) {
          resultLabel.setText("Failed to save customer.");
        }
