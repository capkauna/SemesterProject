...
public class PetshopTest {
    public static void main(String[] args) {
        ...
        PetForSaleContainer petsForSaleList = new PetForSaleContainer(new ArrayList<>());
        ...
        // Add pets
        Pet pet = new Cat("Fluffy", Gender.FEMALE, 2.5, "White", "A fluffy white cat", null, true, "John Doe", "Siamese", "Fish");
        petList.addPet(pet);
